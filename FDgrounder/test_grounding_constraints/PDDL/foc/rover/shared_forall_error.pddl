...
(forall (?r - rover) 
        (and 
            (sometime-before  (exists (?o - objective ?m - mode) (have_image ?r ?o ?m)) (exists (?w - waypoint) (have_rock_analysis ?r ?w))) 
            (forall (?r - rover) (sometime-after  (exists (?w - waypoint) (and (have_rock_analysis ?r ?w) (communicated_rock_data ?w)) ) (exists (?s - store) (and (store_of ?s ?r) (empty ?s)) ))) 
        )
)
